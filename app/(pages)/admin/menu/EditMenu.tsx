...
const EditMenu = ({ item }: { item: any }) => {
  ...
  return (
    <div className="p-4">
      <Dialog>
        <DialogTrigger className="font-medium  w-full text-center flex items-center justify-center bg-[#3C72BE] hover:bg-black duration-100 shadow-lg text-white rounded-lg px-4 py-2 transition-all text-sm ease-in-out">
          Edit
        </DialogTrigger>
